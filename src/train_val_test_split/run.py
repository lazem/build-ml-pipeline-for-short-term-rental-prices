...
if __name__ == "__main__":
    ...
    parser.add_argument("--input", type=str,  required=False, default="clean_sample.csv:latest", help="Input artifact to split")

    parser.add_argument(
        "--test_size", required=False,  type=float, default=0.2, help="Size of the test split. Fraction of the dataset, or number of items"
    )
